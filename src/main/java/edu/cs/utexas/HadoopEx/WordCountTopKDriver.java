...
public class WordCountTopKDriver extends Configured implements Tool {
    ...
    public int run(String args[]) {
        try {
            ...
            // specify a Mapper
            job.setMapperClass(PositionErrorRateMapper.class);

            // specify a Reducer
            job.setReducerClass(PositionErrorRateReducer.class);

            // specify output types
            job.setOutputKeyClass(Text.class);
            job.setOutputValueClass(ErrorCount.class);
            ...
            job2.setOutputValueClass(ErrorCount.class);
